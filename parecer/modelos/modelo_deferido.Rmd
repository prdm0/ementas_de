...
O(a) discente `r toupper(params$nome)`, matrícula Nº `r toupper(params$matricula)`, do curso de `r toupper(params$curso_atual)` da Universidade Federal da Paraíba - UFPB, solicita o aproveitamento da(s) disciplina(s) `r toupper(params$disciplina_cursada)`, cursada na `r toupper(params$instituicao_antiga)`, em `r toupper(params$anos_cursados)`, no curso de `r toupper(params$curso_anterior)`, considerando a equivalência com a disciplina `r toupper(params$disciplina)`, deste departamento.
