...
# Redigir Parecer{data-navmenu="Parecer" data-icon="fa-keyboard"}

### Redigir Parecer {data-navmenu="Parecer"}
...
renderUI({
  downloadButton("downloadREDIGIR", "Baixe o PDF do parecer", style = "width:100%;")
})
```


# Complementação {data-navmenu="Parecer" data-icon="fa-info-circle"}

### Complementação {data-navmenu="Parecer"}
