...
```{r}
tippy::with_tippy(
  textInput(inputId = "instituicaoAnteriorDE", label = "Instituição anterior:", value = ""),
...
output$downloadDE <- downloadHandler(
  ...
  content = function(file) {
    ...
    file.copy(file, to = "parecer/enviar_email/despacho_deferido.pdf", overwrite = TRUE)
...
```{r}
tippy::with_tippy(
  textInput(inputId = "instituicaoAnteriorIND", label = "Instituição anterior:", value = ""),
  tooltip = "Intorme a disciplina cursada na instituição anterior."
)
...
output$downloadIND <- downloadHandler(
  ...
  content = function(file) {
    ...
    file.copy(file, to = "parecer/enviar_email/despacho_indeferido.pdf", overwrite = TRUE)
...
output$downloadCOMP <- downloadHandler(
  ...
  content = function(file) {
    ...
    file.copy(file, to = "parecer/enviar_email/despacho_complementacao.pdf", overwrite = TRUE)
...
#send_email("pedro", "23", "21234", hora = "23", local = "Sala 20 - DE")
